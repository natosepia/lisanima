...
| テーブル | remember | recall | forget | edit | organize | rulebook | topic_manage |
|---------|----------|--------|--------|------|----------|----------|-------------|
| t_sessions | CR | R | - | - | - | - | - |
| t_messages | C | R | U | U | R | - | - |
| t_tags | - | R | - | - | CR | - | - |
| t_message_tags | - | R | - | - | CD | - | - |
| t_topics | R | - | - | - | - | - | CRU |
...
**edit**
- t_messages: `editMessage` でcontent/emotionの指定フィールドのみUPDATE（U）。is_deleted=FALSEのレコードのみ対象
